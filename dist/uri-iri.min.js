...
*/
var URI=function(){function e(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];if(1<a.length){a[0]=a[0].slice(0,-1);for(var b=a.length-1,g=1;g<b;++g)a[g]=a[g].slice(1,-1);a[b]=a[b].slice(1);return a.join("")}return a[0]}function k(a){var b=e("[0-9]","[A-Fa-f]"),g=e("[A-Za-z]","[0-9]","[\\-\\.\\_\\~]",a?"[\\xA0-\\u200D\\u2010-\\u2029\\u202F-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]":"[]");return{v:!1,m:new RegExp(e("[^]","[A-Za-z]","[0-9]","[\\+\\-\\.]"),"g"),o:new RegExp(e("[^\\%\\:]",g,
"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"),"g"),h:new RegExp(e("[^\\%]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"),"g"),i:new RegExp(e("[^\\%\\/\\:\\@]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"),"g"),j:new RegExp(e("[^\\%\\/\\@]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"),"g"),l:new RegExp(e("[^\\%]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]","[\\:\\@\\/\\?]",a?"[\\uE000-\\uF8FF]":"[]"),"g"),g:new RegExp(e("[^\\%]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]","[\\:\\@\\/\\?]"),"g"),c:new RegExp(e("[^]",g,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"),
...
b,c){return v(y(m(a,c),m(b,c),c,!0),c)},normalize:function(a,b){"string"===typeof a?a=v(m(a,b),b):"object"===A(a)&&(a=m(v(a,b),b));return a},equal:function(a,b,c){"string"===typeof a?a=v(m(a,c),c):"object"===A(a)&&(a=v(a,c));"string"===typeof b?b=v(m(b,c),c):"object"===A(b)&&(b=v(b,c));return a===b},escapeComponent:function(a,b){return a&&a.toString().replace(b&&b.iri?z.c:u.c,n)},unescapeComponent:function(a,b){return a&&a.toString().replace(b&&b.iri?z.a:u.a,w)}}}();var B=function(){function e(f){throw new RangeError(y[f]);}function k(f,D){for(var h=f.length,c=[];h--;)c[h]=D(f[h]);return c}function n(f,h){var e=f.split("@"),c="";1<e.length&&(c=e[0]+"@",f=e[1]);f=f.replace(v,".");e=k(f.split("."),h).join(".");return c+e}function w(f){for(var h=[],e=0,c=f.length,p,r;e<c;)p=f.charCodeAt(e++),55296<=p&&56319>=p&&e<c?(r=f.charCodeAt(e++),56320==(r&64512)?h.push(((p&1023)<<10)+(r&1023)+65536):(h.push(p),e--)):h.push(p);return h}function A(f){return k(f,function(f){var e=
...
z=String.fromCharCode;return{version:"1.3.2",w:{decode:w,encode:A},decode:h,encode:m,b:function(f){return n(f,function(f){return l.test(f)?"xn--"+m(f):f})},f:function(f){return n(f,function(f){return C.test(f)?h(f.slice(4).toLowerCase()):f})}}}();URI.SCHEMES.http=URI.SCHEMES.https={domainHost:!0,parse:function(e){e.host||(e.error=e.error||"HTTP URIs must have a host.");return e},serialize:function(e){if(e.port===("https"!==String(e.scheme).toLowerCase()?80:443)||""===e.port)e.port=void 0;e.path||(e.path="/");return e}};
