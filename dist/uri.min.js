/*
 URI.js v1.4.3 (c) 2011 Gary Court. License: http://github.com/garycourt/uri-js
*/
...
"|"+f("2[0-4][0-9]")+"|"+f("1[0-9][0-9]")+"|"+f("[1-9][0-9]")+"|[0-9]");r=f(r+"\\."+r+"\\."+r+"\\."+r);var t=f(j(i,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]","[\\:]")+"+");l=f("v"+l+"+\\."+j(i,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]","[\\:]")+"+");l=f("\\["+f(t+"|"+l)+"\\]");t=f(f(h+"|"+j(i,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]"))+"*");r=f(l+"|"+r+"(?!"+t+")|"+t);l=f("[0-9]*");var s=f(h+"|"+j(i,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]","[\\:\\@]")),u=f(s+"*");t=f(s+"+");var H=f(f(h+"|"+j(i,"[\\!\\$\\&\\'\\(\\)\\*\\+\\,\\;\\=]",
"[\\@]"))+"+");u=f(f("\\/"+u)+"*");var y=f("\\/"+f(t+u)+"?"),z="(?!"+s+")",A=f(f(s+"|[\\/\\?]")+"*");s=f(f(s+"|[\\/\\?]")+"*");var I=RegExp("("+("^("+p+")\\:"+f(f("\\/\\/("+f("("+q+")@")+"?("+r+")"+f("\\:("+l+")")+"?)")+"?("+u+"|"+y+"|"+f(t+u)+"|"+z+")")+f("\\?("+A+")")+"?"+f("\\#("+s+")")+"?$")+")|("+("^(){0}"+f(f("\\/\\/("+f("("+q+")@")+"?("+r+")"+f("\\:("+l+")")+"?)")+"?("+u+"|"+y+"|"+f(H+u)+"|"+z+")")+f("\\?("+A+")")+"?"+f("\\#("+s+")")+"?$")+")"),J=RegExp(j("[^]","[A-Za-z]","[0-9]","[\\+\\-\\.]"),
